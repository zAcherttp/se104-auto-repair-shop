...
describe("Core Functions - Comprehensive Test Suite", () => {
    ...
    describe("Login Function", () => {
        ...
        describe("Successful login scenarios", () => {
            ...
            it("should return ApiResponse structure with success data", async () => {
                mockLogin.mockResolvedValue({
                    error: null,
                    data: { success: true },
                });
        ...
        describe("Edge cases", () => {
            it("should handle empty credentials", async () => {
                ...
                const result = await Login(emptyCredentials as LoginFormData);
            ...
            it("should handle malformed email", async () => {
                ...
                const result = await Login(
                    malformedCredentials as LoginFormData,
                );
    ...
    // ========================================================================
    // SIGNOUT FUNCTION TESTS
    // ========================================================================
    describe("SignOut Function", () => {
        describe("Successful signout scenarios", () => {
        ...
        describe("Failed signout scenarios", () => {
            it("should handle signout error from Supabase", async () => {
                mockSignOut.mockResolvedValue({
            ...
            it("should handle network timeout during signout", async () => {
                mockSignOut.mockResolvedValue({
                    error: new Error("Request timeout"),
                    data: undefined,
                });
            ...
            it("should handle promise rejection", async () => {
                mockSignOut.mockRejectedValue(new Error("Rejection error"));

                await expect(SignOut()).rejects.toThrow("Rejection error");
            });
        });
        ...
        describe("Edge cases", () => {
            ...
            it("should maintain consistent return type", async () => {
                mockSignOut.mockResolvedValue({
                    error: null,
                    data: { success: true },
                });
    ...
    describe("addSparePart Function", () => {
        ...
        describe("Successful spare part creation", () => {
            it("should successfully add a spare part", async () => {
                ...
                expect(mockAddSparePart).toHaveBeenCalledWith(
                    validSparePartData,
                );
                expect(result.error).toBeNull();
        ...
        describe("Failed spare part creation", () => {
            ...
            it("should handle validation errors", async () => {
                ...
                const result = await addSparePart(
                    invalidData as SparePartFormData,
                );
            ...
            it("should handle network failures", async () => {
                mockAddSparePart.mockRejectedValue(
        ...
        describe("Function call tracking", () => {
            ...
            it("should handle multiple consecutive calls", async () => {
                ...
                calls.forEach((callData, index) => {
                    expect(mockAddSparePart).toHaveBeenNthCalledWith(
                        index + 1,
                        callData,
                    );
                });
    ...
    describe("createReception Function", () => {
        ...
        describe("Successful reception creation", () => {
            it("should create reception with new customer and vehicle", async () => {
                ...
                expect(mockCreateReception).toHaveBeenCalledWith(
                    validReceptionData,
                );
                expect(result.error).toBeNull();
                expect(result.data).toEqual({ success: true });
    ...
    describe("removeVehicle Function", () => {
        ...
        describe("Successful vehicle removal", () => {
            ...
            it("should handle deletion of multiple different vehicles", async () => {
                ...
                expect(mockRemoveVehicle).toHaveBeenCalledTimes(
                    vehicleIds.length,
                );
            });
        ...
        describe("Failed vehicle removal", () => {
            ...
            it("should handle network timeout errors", async () => {
                mockRemoveVehicle.mockRejectedValue(
    ...
    describe("Cross-Function Integration", () => {
        it("should maintain consistent ApiResponse structure across Login and SignOut", async () => {
            mockLogin.mockResolvedValue({
                error: null,
                data: { success: true },
            });
            ...
            expect(signOutResult).toHaveProperty("data");
        });
        ...
        it("should track all function calls independently", async () => {
            mockLogin.mockResolvedValue({
                error: null,
                data: { success: true },
            });
            ...
            await SignOut();
            await addSparePart({ name: "Part", price: 10, stock_quantity: 5 });
            ...
            await removeVehicle("vehicle-123");
        ...
        it("should handle all functions rejecting simultaneously", async () => {
            mockLogin.mockRejectedValue(new Error("Login failed"));
            mockSignOut.mockRejectedValue(new Error("SignOut failed"));
            mockAddSparePart.mockRejectedValue(new Error("AddPart failed"));
            mockCreateReception.mockRejectedValue(
                new Error("CreateReception failed"),
            );
            mockRemoveVehicle.mockRejectedValue(
                new Error("RemoveVehicle failed"),
            );
            ...
            await expect(
                addSparePart({ name: "Part", price: 10, stock_quantity: 5 }),
            ).rejects.toThrow("AddPart failed");
            await expect(
                createReception({
                    customerName: "John",
                    licensePlate: "ABC",
            ...
            ).rejects.toThrow("CreateReception failed");
            await expect(removeVehicle("v1")).rejects.toThrow(
                "RemoveVehicle failed",
            );
        });
    });
});
